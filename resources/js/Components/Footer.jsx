                            ...
                            <div className="flex lg:justify-end">
                                <ul id="menu-td-demo-header-menu-5" className="flex flex-wrap lg:flex-nowrap gap-3">
                                    <li className="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-212">
                                        <a href="https://demo.tagdiv.com/newspaper_urban_observer_pro/category/entertainment/"><span
                                            className="td-blm-menu-item-txt">
                                            <h2 className="zTZri">Entertainment</h2>
                                        </span></a></li>
                                    <li className="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-210">
                                        <a href="https://demo.tagdiv.com/newspaper_urban_observer_pro/category/celebrity/"><span
                                            className="td-blm-menu-item-txt"><h2 className="zTZri">Celebrity</h2></span></a>
                                    </li>
                                    <li className="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-215">
                                        <a href="https://demo.tagdiv.com/newspaper_urban_observer_pro/category/scandals/"><span
                                            className="td-blm-menu-item-txt"><h2 className="zTZri">Scandals</h2></span></a>
                                    </li>
                                    <li className="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-211">
                                        <a href="https://demo.tagdiv.com/newspaper_urban_observer_pro/category/drama/"><span
                                            className="td-blm-menu-item-txt"><h2 className="zTZri">Drama</h2></span></a></li>
                                    <li className="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-214">
                                        <a href="https://demo.tagdiv.com/newspaper_urban_observer_pro/category/lifestyle/"><span
                                            className="td-blm-menu-item-txt"><h2 className="zTZri">Lifestyle</h2></span></a></li>
                                    <li className="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-216">
                                        <a href="https://demo.tagdiv.com/newspaper_urban_observer_pro/category/technology/"><span
                                            className="td-blm-menu-item-txt"><h2 className="zTZri">Technology</h2></span></a></li>
                                    <li className="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-213">
                                        <a href="https://demo.tagdiv.com/newspaper_urban_observer_pro/category/health/"><span
                                            className="td-blm-menu-item-txt"><h2 className="zTZri">Health</h2></span></a></li>
                                </ul>
                            </div>
