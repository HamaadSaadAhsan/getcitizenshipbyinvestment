...
import "../../scss/ck-editor-custom-styles.scss"
import {
    ClassicEditor,
    Alignment,
    Autoformat,
...
const CKEditorComponent = ({ data = '', onChange }) => {
    ...
    const editorConfiguration = {
        plugins: [
            ...
            CloudServices, Code, CodeBlock, Essentials, FindAndReplace,
            Font, GeneralHtmlSupport, Heading, Highlight, HorizontalLine,
            Image, ImageCaption, ImageInsert, ImageResize, ImageStyle,
            ImageToolbar, ImageUpload, Base64UploadAdapter, Indent, IndentBlock,
            Italic, Link, LinkImage, List, ListProperties, MediaEmbed,
            Mention, PageBreak, Paragraph, PasteFromOffice, PictureEditing,
            RemoveFormat, SpecialCharacters, SpecialCharactersEmoji,
            SpecialCharactersEssentials, Strikethrough, Style, Subscript,
        ...
        <div className="editor-container">
            ...
            <div className="flex justify-end gap-2">
                <div className="flex gap-2">
                    ...
                    <div className="text-gray-800">{words}</div>
                </div>
                <div className="flex gap-2">
                    <div className="text-gray-500">Characters</div>
                    <div className="text-gray-800">{characters}</div>
                </div>
            </div>
        </div>
    );
