                            ...
                            <div className="sc-2b5e3b35-3 kZrEzh">
                                <div data-testid="popoverWrapper" id="popover-wrapper" className={`sc-93f6dc26-1 fRrxoV`}>
                                    <div data-testid="popoverTrigger" id="popover-trigger">
                                        <button type="button" data-testid="socialShareTriggerButton" aria-label="Share" className="sc-a8273305-2 sc-a8273305-5 sc-a8273305-6 hYnulS cUALdr ketEwj" onClick={togglePopover}>
