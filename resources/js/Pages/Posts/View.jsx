        ...
        <Layout categories={categories}>
            ...
            <article>
                            ...
                            <div className="sc-2b5e3b35-3 kZrEzh">
                                <div data-testid="popoverWrapper" id="popover-wrapper" className={`sc-93f6dc26-1 fRrxoV`}>
                                    <div data-testid="popoverTrigger" id="popover-trigger">
                                        <button type="button" data-testid="socialShareTriggerButton" onClick={togglePopover} aria-label="Share" className="sc-a8273305-2 sc-a8273305-5 sc-a8273305-6 hYnulS cUALdr ketEwj" onClick={togglePopover}>
                                            <span data-testid="button-icon-wrapper" className="sc-a8273305-0 kTVKRs">
                                                <svg width="12" height="14" viewBox="0 0 12 14" xmlns="http://www.w3.org/2000/svg" category="social" icon="share" aria-hidden="true" className="sc-2c06e71a-0 fsMljb">
                                                    <path fillRule="evenodd" clipRule="evenodd" d="M9.51768 8.96851C8.95518 8.96851 8.44393 9.19851 8.07227 9.57018L4.19727 7.36685C4.24893 7.18768 4.2856 7.00185 4.2856 6.80685C4.2856 6.61102 4.24977 6.42518 4.19893 6.2456L8.06143 4.04935C8.43393 4.42602 8.94977 4.66102 9.51768 4.66102C10.661 4.66102 11.5852 3.73643 11.5852 2.60893C11.5852 1.46518 10.661 0.541016 9.51768 0.541016C8.38977 0.541016 7.4656 1.46518 7.4656 2.60893C7.4656 2.78727 7.49602 2.95768 7.53935 3.12352L3.70727 5.37643C3.33143 4.98477 2.80477 4.73935 2.2181 4.73935C1.09018 4.73935 0.166016 5.6631 0.166016 6.80685C0.166016 7.93476 1.09018 8.85851 2.2181 8.85851C2.8006 8.85851 3.32435 8.61726 3.69977 8.23268L7.54602 10.4943C7.49893 10.6681 7.4656 10.8473 7.4656 11.036C7.4656 12.1639 8.38977 13.0881 9.51768 13.0881C10.661 13.0881 11.5852 12.1639 11.5852 11.036C11.5852 9.89268 10.661 8.96851 9.51768 8.96851">
                                                    </path>
                                                </svg>
                                            </span>
                                            <span data-testid="button-text" aria-hidden="false" className="sc-a8273305-1 juomiH">Share</span>
                                        </button>
                                    </div>

                                    <div data-testid="popoverStyled" className={`sc-93f6dc26-2 ${isPopoverOpen ? "gNEKVR" : 'hidden'} popover`}>
                                        <button type="button" data-testid="facebookShareButton" aria-label="Facebook" className="sc-a8273305-2 sc-a8273305-5 sc-a8273305-6 sc-a8273305-7 oyzDp cUALdr juiFjD jciIjj">
                                            <span data-testid="button-icon-wrapper" className="sc-a8273305-0 gWwQNU"><svg width="9" height="16" viewBox="0 0 9 16" xmlns="http://www.w3.org/2000/svg" category="social" icon="facebook" aria-hidden="true" className="sc-2c06e71a-0 fsMljb">
                                            ...
                                            <span data-testid="button-text" aria-hidden="false" className="sc-a8273305-1 juomiH">Facebook</span>
                                        </button>
                                        <button type="button" data-testid="twitterShareButton" aria-label="X (Twitter)" className="sc-a8273305-2 sc-a8273305-5 sc-a8273305-6 sc-a8273305-7 oyzDp cUALdr juiFjD jciIjj">
                                            <span data-testid="button-icon-wrapper" className="sc-a8273305-0 gWwQNU">
                                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" category="social" icon="x" aria-hidden="true" className="sc-2c06e71a-0 fsMljb">
                                            ...
                                            <span data-testid="button-text" aria-hidden="false" className="sc-a8273305-1 juomiH">X (Twitter)</span>
                                        </button>
                                        <button type="button" data-testid="linkedinShareButton" aria-label="LinkedIn" className="sc-a8273305-2 sc-a8273305-5 sc-a8273305-6 sc-a8273305-7 oyzDp cUALdr juiFjD jciIjj">
                                            <span data-testid="button-icon-wrapper" className="sc-a8273305-0 gWwQNU">
                                                <svg width="15" height="15" viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg" category="social" icon="linkedin" aria-hidden="true" className="sc-2c06e71a-0 fsMljb">
                                            ...
                                            <span data-testid="button-text" aria-hidden="false" className="sc-a8273305-1 juomiH">LinkedIn</span>
                                        </button>
                                        <button type="button" data-testid="emailShareButton" aria-label="Email" className="sc-a8273305-2 sc-a8273305-5 sc-a8273305-6 sc-a8273305-7 oyzDp cUALdr juiFjD jciIjj">
                                            <span data-testid="button-icon-wrapper" className="sc-a8273305-0 gWwQNU">
                                                <svg width="16" height="12" viewBox="0 0 16 12" xmlns="http://www.w3.org/2000/svg" category="social" icon="email" aria-hidden="true" className="sc-2c06e71a-0 fsMljb">
                                                    <path fillRule="evenodd" clipRule="evenodd" d="M0.480469 11.9585H15.5175V0.0410156H0.480469V11.9585ZM13.391 1.30052L7.99897 5.92452L2.60797 1.30052H13.391ZM14.2025 2.06252V10.6615H1.79647V2.06252L7.99897 7.91752L14.2025 2.06252Z"></path>
                                                </svg>
                                            </span>
                                            <span data-testid="button-text" aria-hidden="false" className="sc-a8273305-1 juomiH">Email</span>
                                        </button>
                                        <button type="button" data-testid="copyShareButton" aria-label="Copy" className="sc-a8273305-2 sc-a8273305-5 sc-a8273305-6 sc-a8273305-7 oyzDp cUALdr juiFjD jciIjj">
                                            <span data-testid="button-icon-wrapper" className="sc-a8273305-0 gWwQNU">
                                                <svg width="14" height="16" viewBox="0 0 14 16" xmlns="http://www.w3.org/2000/svg" category="social" icon="copy" aria-hidden="true" className="sc-2c06e71a-0 fsMljb">
                                                    <path fillRule="evenodd" clipRule="evenodd" d="M0.128906 0.480469V11.759H3.90691V15.518H13.8699V4.23997H10.0914V0.480469H0.128906ZM1.46341 1.79647H8.75691V4.23997H3.90691V10.4425H1.46341V1.79647ZM5.24191 14.2025H12.5344V5.55547H5.24191V14.2025Z"></path>
                                                </svg>
                                            </span>
                                            <span data-testid="button-text" aria-hidden="false" className="sc-a8273305-1 juomiH">Copy</span>
                                        </button>
                                        <button data-testid="popoverCloseButton" className="sc-93f6dc26-3 hNMPSK">
                                            <svg viewBox="0 0 32 32" width="20" height="20" category="actions" icon="close" className="sc-2c06e71a-0 fsMljb">
                ...
                <div className="dlWCEZ">
                    <div dangerouslySetInnerHTML={{ __html: post.content.replace(/<p>/g, '<p class="fYAfXe">') }}></div>
                </div>
                {/* meta block */}
            </article>
